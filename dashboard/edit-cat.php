...
?>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $query = "UPDATE categories SET categorie_name='$categoryName' WHERE id = '$id'";
        ...
        <div class="edit-cat">
            <form action="edit-cat.php?id=<?php echo $row['id']; ?>" method="POST">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="cat" value="<?php echo $row['categorie_name']; ?>" name="category">
                </div>
